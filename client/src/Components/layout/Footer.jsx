...
const Footer = () => {
  ...
  const companyLinks = navItems.filter(
    (item) =>
      item.title !== "Services" && item.title !== "Chennai Banking Jobs",
  );
  const jobLinks = navItems.filter(
    (item) => item.title === "Chennai Banking Jobs",
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="text-sm leading-relaxed mb-8 max-w-xs">
                Core Talents – AI-powered recruitment with 48-hour delivery, 95%
                fit rate, and hire-first-pay-later model. Trusted by 25+
                corporates.
              </p>
              <div className="flex gap-4">
                <SocialIcon
                  icon={<Facebook size={18} />}
                  href="https://www.facebook.com/profile.php?id=61581767384156"
                />
                <SocialIcon
                  icon={<Instagram size={18} />}
                  href="https://www.instagram.com/core_talents/"
                />
                <SocialIcon
