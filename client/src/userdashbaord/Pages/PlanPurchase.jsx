...
const PlanPurchase = () => {
  ...
  const handleBuy = async (plan) => {
    ...
    try {
      ...
      console.error(error);
      showToast("Transaction initialization failed", "error");
    } finally {
      setProcessingId(null);
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            Unlock professional templates, unlimited resumes, and AI-powered
          ...
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                <div className="mb-8">
                  <h3
                    className={`text-lg font-bold mb-2 ${isPopular ? "text-indigo-600" : "text-slate-800"}`}
                  >
                    {plan.name}
                  </h3>
                ...
                <ul className="space-y-4 mb-8 flex-1">
                  ...
                  <li className="flex items-start gap-3">
                    <div
                      className={`mt-1 p-0.5 rounded-full ${isPopular ? "bg-indigo-100 text-indigo-600" : "bg-slate-100 text-slate-500"}`}
                    >
